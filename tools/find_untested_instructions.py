            ...
            with open(test_file, 'r') as f:
                for line in f:
                    ...
                    if match:
                        ...
                        # Add both forms: base and record form
                        instructions_in_file.add(mnemonic)
                        if has_dot:
                            # "add." also tests "addx" opcode
            ...
            for line in f:
                ...
                if in_enum:
                    ...
                    if match:
                        ...
                        # Remove 'x' suffix from opcodes like 'addx' -> 'add'
                        # But keep opcodes that actually end in 'x' like 'lhax'
                        if opcode.endswith('x') and opcode not in ['lhax', 'lhaux', 'lwax', 'lwaux']:
                            # This is the extended opcode form
                            base = opcode[:-1]
                            opcodes.add(base)
                        opcodes.add(opcode)
    except Exception as e:
